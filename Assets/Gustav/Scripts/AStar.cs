...
public class AStar : MonoBehaviour
{
    ...
    public List<Vector2Int> FindPath(Vector2Int _start, Vector2Int _target)
    {
        ...
        for (int x = 0; x < gridWidth; x++)
        {
            ...
            {
                Vector2Int worldPosition = new (x + gridOffsetX, y + gridOffsetY);

                nodes[x, y] = new Node(worldPosition, new Vector2Int(x, y), true);
    ...
    private void GetNeighbors(Vector2Int position, List<Node> list)
    {
        list.Clear();
